...
t 2 = test_list "test_word16" [ test_equal "" 0 (p "\0\0")
                                 , test_equal "" 1 (p "\0\1")
...
t 3 = test_list "test_word32" [ test_equal "" 0 (p "\0\0\0\0")
...
t 4 = test_list "test_decodeBytesWith" [ test_equal "" b (p [b]) | b <- [0..255] ] where
